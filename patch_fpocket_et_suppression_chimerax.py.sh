cat > patch_fpocket_et_suppression_chimerax.py << 'PYEOF'
#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""
Patch en une passe :
...
if __name__ == "__main__":
    main()
PYEOF
echo "Script cree : patch_fpocket_et_suppression_chimerax.py"
echo
echo "Verification d'abord (aucune modification) :"
echo "  python3 patch_fpocket_et_suppression_chimerax.py --check"
echo
echo "Puis application reelle :"
echo "  python3 patch_fpocket_et_suppression_chimerax.py"
